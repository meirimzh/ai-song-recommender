...
def run_clustering(input_path="data/clean_dataset.csv", output_path="data/clean_tracks_with_clusters.csv"):
    df = load_clean_data(input_path) # Load the clean dataset
